...
document.addEventListener("DOMContentLoaded", function () {
  const imageOnlyParagraphs = document.querySelectorAll(".content p");

  imageOnlyParagraphs.forEach(function (paragraph) {
    if (
      ...
      paragraph.firstElementChild.style.display = "inline-block";
      paragraph.firstElementChild.style.margin = "1rem auto";
      paragraph.firstElementChild.style.maxWidth = "100%";
      paragraph.firstElementChild.style.height = "auto";
    }
  });
});
